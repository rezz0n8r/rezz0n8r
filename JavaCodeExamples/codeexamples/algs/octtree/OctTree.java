...
public class OctTree<K, V> {
     ...
     * 
     */
    private OctNode<K, V> findSmallestOctantContainingPointR(OctNode<K, V> focusNode, Vector3D point3d, ConvexVolume smallestOctantYet) {
    ...
    public OctNode<K,V> findSmallestOctantEntirelyContainingSearchVolume(ConvexVolume searchVol) throws OctTreeException{
